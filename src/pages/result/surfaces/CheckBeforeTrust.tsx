...
const PAGE_SUBTITLE = "Honest about what AI is, what it isn't, and the rules I follow to stay sane around it.";

const CheckBeforeTrust = () => {
...
export default CheckBeforeTrust;
